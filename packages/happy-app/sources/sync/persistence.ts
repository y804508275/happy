...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'droid';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'droid'
            ? parsed.agentType
            : 'claude';
