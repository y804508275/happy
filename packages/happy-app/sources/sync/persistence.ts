...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'droid' | 'opencode';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'droid' || parsed.agentType === 'opencode'
            ? parsed.agentType
            : 'claude';
