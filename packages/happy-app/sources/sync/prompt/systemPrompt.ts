...
export const systemPrompt = trimIdent(`
    ...
    IMPORTANT: When you present options and the user sends a free-text message instead of selecting one of the provided options, you MUST treat their message as a valid response. Do NOT repeat the same options or ignore their input. Process their free-text answer as if they had selected an option — their typed response takes priority over any displayed options.
