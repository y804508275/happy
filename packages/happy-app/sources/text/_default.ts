...
export const en = {
    ...
    knowledgeBase: {
        ...
        deleteConfirmMessage: ({ name }: { name: string }) =>
            `Delete "${name}"? This cannot be undone.`,
        alwaysActive: 'Always active',
        onDemand: 'On-demand',
        toggleToOnDemand: 'Switch to On-demand',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" will no longer be auto-injected. You can still apply it manually per message.`,
    ...
    mdReference: {
        ...
        emptyDescription: 'Create rules in Knowledge Base to apply them to your messages.',
        newButton: 'New',
        createTitle: 'New Rule',
        editTitle: 'Edit Rule',
        nameLabel: 'Title',
        namePlaceholder: 'Rule title',
        descriptionLabel: 'Description',
        descriptionPlaceholder: 'Brief description (optional)',
        contentLabel: 'Content',
        contentPlaceholder: 'Rule content in markdown...',
        scopeLabel: 'Scope',
        scopeGlobal: 'Global',
        ...
        instructionPlaceholder: 'What should this rule do? (e.g. "Follow this template")',
    },
