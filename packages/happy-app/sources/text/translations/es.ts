...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        restartSessionConfirm: '¿Reiniciar el proceso de la sesión para aplicar actualizaciones de código? La conversación continuará.',
        restartSessionSubtitle: 'Aplicar actualizaciones de código',
        restartSessionStarted: 'La sesión se está reiniciando. Se desconectará brevemente y luego volverá.',
    ...
    knowledgeBase: {
        ...
        emptyTitle: 'Sin elementos en la base de conocimiento',
        emptyDescription: 'Los elementos guardados de tus sesiones de código aparecerán aquí.',
        deleteConfirm: 'Eliminar elemento',
        deleteConfirmMessage: ({ name }: { name: string }) => `¿Eliminar "${name}"? Esta acción no se puede deshacer.`,
        alwaysActive: 'Siempre activo',
        onDemand: 'Bajo demanda',
        toggleToOnDemand: 'Cambiar a bajo demanda',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" ya no se inyectará automáticamente. Puedes aplicarlo manualmente por mensaje.`,
        toggleToAlwaysActive: 'Cambiar a siempre activo',
        toggleToAlwaysActiveMessage: ({ name }: { name: string }) =>
            `"${name}" se inyectará automáticamente en cada mensaje.`,
    ...
    mdReference: {
        ...
        emptyDescription: 'Crea reglas en la base de conocimiento para aplicarlas a tus mensajes.',
        newButton: 'Nuevo',
        createTitle: 'Nueva regla',
        editTitle: 'Editar regla',
        nameLabel: 'Título',
        ...
        contentPlaceholder: 'Contenido de la regla (Markdown)...',
        scopeLabel: 'Alcance',
        scopeGlobal: 'Global',
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `¿Eliminar "${name}"? Esta acción no se puede deshacer.`,
        instructionPlaceholder: '¿Qué debe hacer esta regla? (ej. "Seguir esta plantilla")',
    },
    ...
    components: {
        emptyMainScreen: {
            ...
            noSessions: 'Sin conversaciones aún',
    ...
    settingsAccount: {
        ...
        feishu: 'Feishu',
        linkFeishu: 'Vincular cuenta de Feishu',
        linkFeishuSubtitle: 'Vincula Feishu para iniciar sesión en diferentes dispositivos',
        feishuLinked: 'Cuenta de Feishu',
        feishuLinkedUnknown: 'Vinculada',
        feishuLinkedSubtitle: 'Toca para vincular otra cuenta',
    },
    ...
    welcome: {
        ...
        loginWithFeishu: 'Iniciar sesión con Feishu',
    },
    ...
    markdown: {
        ...
        expandCode: ({ lines }: { lines: number }) => `Mostrar ${lines} líneas`,
