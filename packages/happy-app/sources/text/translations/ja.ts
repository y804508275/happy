...
export const ja: TranslationStructure = {
    ...
    knowledgeBase: {
        ...
        alwaysActive: '常時有効',
        onDemand: 'オンデマンド',
        toggleToOnDemand: 'オンデマンドに切り替え',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `「${name}」は自動注入されなくなります。メッセージごとに手動で適用できます。`,
    ...
    mdReference: {
        ...
        emptyDescription: 'ナレッジベースでルールを作成し、メッセージに適用できます。',
        newButton: '新規',
        createTitle: '新規ルール',
        editTitle: 'ルールを編集',
        nameLabel: 'タイトル',
        namePlaceholder: 'ルールタイトル',
        descriptionLabel: '説明',
        descriptionPlaceholder: '簡単な説明（任意）',
        contentLabel: '内容',
        contentPlaceholder: 'ルール内容（Markdown形式）...',
        scopeLabel: 'スコープ',
        scopeGlobal: 'グローバル',
        scopeProject: 'プロジェクト',
        save: '保存',
        ...
        instructionPlaceholder: 'このルールで何をしますか？（例：「このテンプレートに従う」）',
    },
