...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        restartSessionConfirm: 'Reiniciar o processo da sessão para aplicar atualizações de código? A conversa continuará.',
        restartSessionSubtitle: 'Aplicar atualizações de código',
        restartSessionStarted: 'A sessão está reiniciando. Ficará brevemente offline e depois voltará.',
        ...
        renameSessionPlaceholder: 'Insira o nome da sessão',
    ...
    knowledgeBase: {
        ...
        toggleToOnDemand: 'Mudar para sob demanda',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" não será mais injetado automaticamente. Você ainda pode aplicá-lo manualmente por mensagem.`,
        toggleToAlwaysActive: 'Mudar para sempre ativo',
        toggleToAlwaysActiveMessage: ({ name }: { name: string }) =>
            `"${name}" será injetado automaticamente em cada mensagem.`,
    ...
    mdReference: {
        ...
        emptyDescription: 'Crie regras na base de conhecimento para aplicá-las às suas mensagens.',
        newButton: 'Novo',
        createTitle: 'Nova regra',
        editTitle: 'Editar regra',
        nameLabel: 'Título',
        namePlaceholder: 'Título da regra',
        descriptionLabel: 'Descrição',
        descriptionPlaceholder: 'Descrição breve (opcional)',
        contentLabel: 'Conteúdo',
        contentPlaceholder: 'Conteúdo da regra (Markdown)...',
        scopeLabel: 'Escopo',
        scopeGlobal: 'Global',
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `Excluir "${name}"? Esta ação não pode ser desfeita.`,
        instructionPlaceholder: 'O que esta regra deve fazer? (ex. "Seguir este modelo")',
    },
    ...
    agentInput: {
        ...
        autoConfirm: {
            ...
            descOff: 'Cada ação precisa da sua aprovação',
            descConfirm: 'Aprovar permissões automaticamente, respostas manuais',
            descAll: 'Aprovar permissões e responder perguntas automaticamente',
        },
        messageQueue: {
    ...
    markdown: {
        ...
        expandCode: ({ lines }: { lines: number }) => `Mostrar ${lines} linhas`,
        collapseCode: 'Recolher',
    },
