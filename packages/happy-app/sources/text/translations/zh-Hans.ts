...
export const zhHans: TranslationStructure = {
    ...
    knowledgeBase: {
        ...
        alwaysActive: '始终生效',
        onDemand: '按需引用',
        toggleToOnDemand: '切换为按需引用',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" 将不再自动注入。你仍可在发送消息时手动选择引用。`,
    ...
    mdReference: {
        ...
        globalSection: '全局',
        projectSection: '项目',
        emptyDescription: '在知识库中创建规则，然后在消息中引用它们。',
        newButton: '新建',
        createTitle: '新建规则',
        editTitle: '编辑规则',
        nameLabel: '标题',
        namePlaceholder: '规则标题',
        descriptionLabel: '描述',
        descriptionPlaceholder: '简短描述（可选）',
        contentLabel: '内容',
        contentPlaceholder: '规则内容（Markdown 格式）...',
        scopeLabel: '范围',
        scopeGlobal: '全局',
        scopeProject: '项目',
        save: '保存',
        ...
        instructionPlaceholder: '这条规则要做什么？（如"按此模板生成代码"）',
    },
