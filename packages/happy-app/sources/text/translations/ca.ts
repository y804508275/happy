...
export const ca: TranslationStructure = {
    ...
    knowledgeBase: {
        ...
        onDemand: 'Sota demanda',
        toggleToOnDemand: 'Canviar a sota demanda',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" ja no s'injectarà automàticament. Encara el pots aplicar manualment per missatge.`,
    ...
    mdReference: {
        ...
        emptyDescription: 'Crea regles a la base de coneixement per aplicar-les als teus missatges.',
        newButton: 'Nou',
        createTitle: 'Nova regla',
        editTitle: 'Edita regla',
        nameLabel: 'Títol',
        namePlaceholder: 'Títol de la regla',
        descriptionLabel: 'Descripció',
        descriptionPlaceholder: 'Descripció breu (opcional)',
        contentLabel: 'Contingut',
        contentPlaceholder: 'Contingut de la regla (Markdown)...',
        scopeLabel: 'Abast',
        scopeGlobal: 'Global',
        scopeProject: 'Projecte',
        save: 'Desa',
        deleteConfirm: 'Elimina regla',
        deleteConfirmMessage: ({ name }: { name: string }) => `Eliminar "${name}"? Aquesta acció no es pot desfer.`,
        instructionPlaceholder: 'Què ha de fer aquesta regla? (ex. "Segueix aquesta plantilla")',
    },
    ...
    tools: {
        ...
        taskViewFull: {
            taskPrompt: 'Descripció de la tasca',
            executionDetails: 'Detalls d\'execució',
            result: 'Resultat',
            noDetails: 'No hi ha detalls d\'execució disponibles',
            agentResponse: 'Agent',
            userMessage: 'Usuari',
        },
        multiEdit: {
