...
export const ru: TranslationStructure = {
    ...
    knowledgeBase: {
        ...
        onDemand: 'По запросу',
        toggleToOnDemand: 'Переключить на «По запросу»',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" больше не будет автоматически внедряться. Вы можете применять вручную.`,
    ...
    mdReference: {
        ...
        emptyDescription: 'Создавайте правила в базе знаний и применяйте их к сообщениям.',
        newButton: 'Создать',
        createTitle: 'Новое правило',
        editTitle: 'Редактировать правило',
        nameLabel: 'Название',
        namePlaceholder: 'Название правила',
        descriptionLabel: 'Описание',
        descriptionPlaceholder: 'Краткое описание (необязательно)',
        contentLabel: 'Содержимое',
        contentPlaceholder: 'Содержимое правила (Markdown)...',
        scopeLabel: 'Область',
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `Удалить "${name}"? Это действие нельзя отменить.`,
        instructionPlaceholder: 'Что делать с этим правилом? (напр. "Следуй этому шаблону")',
    },
