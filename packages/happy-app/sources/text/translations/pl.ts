...
export const pl: TranslationStructure = {
    ...
    knowledgeBase: {
        ...
        onDemand: 'Na żądanie',
        toggleToOnDemand: 'Przełącz na żądanie',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" nie będzie już automatycznie wstrzykiwane. Nadal możesz je stosować ręcznie.`,
    ...
    mdReference: {
        ...
        emptyDescription: 'Twórz reguły w bazie wiedzy i stosuj je do wiadomości.',
        newButton: 'Nowy',
        createTitle: 'Nowa reguła',
        editTitle: 'Edytuj regułę',
        nameLabel: 'Tytuł',
        namePlaceholder: 'Tytuł reguły',
        descriptionLabel: 'Opis',
        descriptionPlaceholder: 'Krótki opis (opcjonalnie)',
        contentLabel: 'Treść',
        contentPlaceholder: 'Treść reguły (Markdown)...',
        scopeLabel: 'Zakres',
        scopeGlobal: 'Globalny',
        scopeProject: 'Projekt',
        save: 'Zapisz',
        deleteConfirm: 'Usuń regułę',
        deleteConfirmMessage: ({ name }: { name: string }) => `Usunąć "${name}"? Tej operacji nie można cofnąć.`,
        instructionPlaceholder: 'Co ta reguła powinna robić? (np. "Postępuj według tego szablonu")',
    },
    ...
    tools: {
        ...
        taskViewFull: {
            taskPrompt: 'Opis zadania',
            executionDetails: 'Szczegóły wykonania',
            result: 'Wynik',
            noDetails: 'Brak szczegółów wykonania',
            agentResponse: 'Agent',
            userMessage: 'Użytkownik',
        },
        multiEdit: {
    ...
    settingsAccount: {
        ...
        feishuLinked: 'Konto Feishu',
        feishuLinkedUnknown: 'Połączono',
        feishuLinkedSubtitle: 'Dotknij, aby połączyć inne konto',
    },
    ...
    markdown: {
        ...
        expandCode: ({ lines }: { lines: number }) => `Pokaż ${lines} linii`,
        collapseCode: 'Zwiń',
    },
