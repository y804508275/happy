...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionPlaceholder: 'Inserisci il nome della sessione',
    ...
    knowledgeBase: {
        ...
        toggleToOnDemand: 'Passa a su richiesta',
        toggleToOnDemandMessage: ({ name }: { name: string }) =>
            `"${name}" non verrà più iniettato automaticamente. Puoi applicarlo manualmente per messaggio.`,
    ...
    mdReference: {
        title: 'REGOLE',
        globalSection: 'GLOBALE',
        projectSection: 'PROGETTO',
        emptyDescription: 'Crea regole nella base di conoscenza per applicarle ai tuoi messaggi.',
        newButton: 'Nuovo',
        createTitle: 'Nuova regola',
        editTitle: 'Modifica regola',
        nameLabel: 'Titolo',
        namePlaceholder: 'Titolo della regola',
        descriptionLabel: 'Descrizione',
        descriptionPlaceholder: 'Breve descrizione (opzionale)',
        contentLabel: 'Contenuto',
        contentPlaceholder: 'Contenuto della regola (Markdown)...',
        scopeLabel: 'Ambito',
        scopeGlobal: 'Globale',
        scopeProject: 'Progetto',
        save: 'Salva',
        deleteConfirm: 'Elimina regola',
        deleteConfirmMessage: ({ name }: { name: string }) => `Eliminare "${name}"? Questa azione non può essere annullata.`,
        instructionPlaceholder: 'Cosa deve fare questa regola? (es. "Segui questo modello")',
    },
    ...
    tools: {
        ...
        taskViewFull: {
            taskPrompt: 'Descrizione del compito',
            executionDetails: 'Dettagli di esecuzione',
            result: 'Risultato',
            noDetails: 'Nessun dettaglio di esecuzione disponibile',
            agentResponse: 'Agent',
            userMessage: 'Utente',
        },
        askUserQuestion: {
    ...
    settingsAccount: {
        ...
        feishu: 'Feishu',
        linkFeishu: 'Collega account Feishu',
        linkFeishuSubtitle: 'Collega Feishu per accedere su diversi dispositivi',
        feishuLinked: 'Account Feishu',
        feishuLinkedUnknown: 'Collegato',
        feishuLinkedSubtitle: 'Tocca per collegare un altro account',
    },
    ...
    welcome: {
        ...
        loginWithFeishu: 'Accedi con Feishu',
    },
    ...
    preview: {
        ...
        loadingError: 'Impossibile caricare questa pagina',
    },
